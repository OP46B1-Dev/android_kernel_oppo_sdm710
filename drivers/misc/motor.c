...
/*qpnp_is_power_off_charging() is built unconditionally in
 * drivers/soc/oplus/project_info/boot_mode.c but its declaration in
 * <soc/oplus/boot_mode.h> is hidden behind OPLUS_BUG_STABILITY, which this
 * tree does not define. Declare it locally so motor.c can use it.
 */
