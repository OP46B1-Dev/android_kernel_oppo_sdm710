...
static int bq27541_get_battery_soh(void)	/*  sjc20150105  */
{
	...
	/*
	 * BQ27411 StateOfHealth() packs the percentage in bits [7:0] and
	 * the SOH status in bits [15:8].  Android exposes this vendor
	 * property as a percentage, so do not leak the status byte into it.
	 */
	soh &= 0xff;
