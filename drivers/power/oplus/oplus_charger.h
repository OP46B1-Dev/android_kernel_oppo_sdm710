...
/*	struct battery_data battery_main	*/
	...
	bool framework_works_initialized;
	bool framework_awake_initialized;
	bool framework_fb_registered;
	bool framework_proc_initialized;
	bool framework_debug_initialized;
	bool framework_stopping;
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 9, 0))
	struct wake_lock suspend_lock;
#else
	struct wakeup_source *suspend_ws;
	bool suspend_ws_active;
#endif
